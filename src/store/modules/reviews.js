...
/*      {
      ...
      },
      {
        id: 2,
        name: 'Ирина',
        review: 'Спасибо огромное Гуляй Виляй за помощь с нашим малышом во время карантина! Нашим выгульщиком стала Полина, внимательная девушка с очаровательным юмором. Наш такс влюбился и доверился ей с первой же встречи! Отдельное спасибо за милейшим отчётам по прогулкам! Я думаю Томми будет немного скучать по Полине ;)',
        avatar: '',
        grade: 3
      },
      {
